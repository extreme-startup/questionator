...
export class InitialStructure1556056059333 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `contest_sessions` (`id` varchar(36) NOT NULL, `status` varchar(255) NOT NULL DEFAULT 'created', `started_time` timestamp NULL, `include_previous_rounds` tinyint NOT NULL DEFAULT 1, `active_round` int NOT NULL DEFAULT 1, `contestId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `questions_rounds` (`roundsId` varchar(255) NOT NULL, `questionsId` varchar(255) NOT NULL, INDEX `IDX_01b48204b362820cf4ad75e6c9` (`roundsId`), INDEX `IDX_f7d24b150340b93aaf7d0721a0` (`questionsId`), PRIMARY KEY (`roundsId`, `questionsId`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `contest_sessions` ADD CONSTRAINT `FK_537074a9403f4bd000bd31bd6d6` FOREIGN KEY (`contestId`) REFERENCES `contests`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `contest_sessions` DROP FOREIGN KEY `FK_537074a9403f4bd000bd31bd6d6`");
