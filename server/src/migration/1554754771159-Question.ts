...
export class Question1554754771159 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        ' `answer` varchar(255) NOT NULL, `value` varchar(255) NOT NULL, `isDeleted` tinyint NOT NULL DEFAULT 0, `contestId` int NULL, ' +
